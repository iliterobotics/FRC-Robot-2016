...
public class RobotConfiguration {
    ...
    public static void configureRobot() {
        ...
        JoystickButtonMap.getInstance().addControllerButton(RobotButtonType.GEAR_SHIFT, new JoystickButtonMatch(RobotJoystickType.LEFT_DRIVE, 5));
        ...
        // JoystickButtonMap.getInstance().addControllerButton(RobotButtonType.SHOOTER_TWIST_LEFT,
        // new JoystickButtonMatch(RobotJoystickType.CONTROLLER, 1));
        // JoystickButtonMap.getInstance().addControllerButton(RobotButtonType.SHOOTER_TWIST_RIGHT,
        ...
        // JoystickButtonMap.getInstance().addControllerButton(RobotButtonType.READY_HIGH,
        // new JoystickButtonMatch(RobotJoystickType.CONTROLLER,1));
        // JoystickButtonMap.getInstance().addControllerButton(RobotButtonType.READY_LOW,
        // new JoystickButtonMatch(RobotJoystickType.CONTROLLER,2));
        // JoystickButtonMap.getInstance().addControllerButton(RobotButtonType.AIM,
        // new JoystickButtonMatch(RobotJoystickType.CONTROLLER,3));
        ...
        RobotControlWithSRX.getInstance().addTalonOutput(RobotMotorType.ACTIVE_INTAKE, 7);
        ...
        RobotControlWithSRX.getInstance().addDoubleSolenoid(RobotPneumaticType.INTAKE_SETTER, 0);
