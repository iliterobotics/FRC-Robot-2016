...
public class Alignment implements Module {
    ...
    @Override
    public void update() {
        if(SensorInputControl.getInstance().isActive(SensorType.TOUCH_SENSOR_TOTE_LEFT)){
            left = Value.kOn;
        }
    ...
    public void updateOutputs() {
        RobotControl.getInstance().updateRelay(RobotMotorType.ALIGNMENT_LEFT, left);
        RobotControl.getInstance().updateRelay(RobotMotorType.ALIGNMENT_RIGHT, right);
    }
