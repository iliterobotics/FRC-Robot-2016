...
//    }
    ...
    public void update() {
        ...
        // {
        // System.out.println(getCurrent(ct.getDeviceID()) + "This is current
        // for talon ID : " + ct.getDeviceID());
        // }
        // for(CANTalon ct : rsrx.getRightDrive())
        // {
        // System.out.println(getCurrent(ct.getDeviceID()) + "This is current
        ...
        // for(RobotMotorType ct : rsrx.getTalons().keySet())
        // {
        // System.out.println(getCurrent(rsrx.getTalons().get(ct).getDeviceID())
        ...
        // for(CANTalon ct : rsrx.getLeftDrive())
        // {
        // System.out.println(getEncoderPos(ct.getDeviceID()) + "This is encoder
        // position for talon ID : " + ct.getDeviceID());
        // }
        // for(CANTalon ct : rsrx.getRightDrive())
        // {
        // System.out.println(getEncoderPos(ct.getDeviceID()) + "This is encoder
        ...
        // for(RobotMotorType ct : rsrx.getTalons().keySet())
        // {
        // System.out.println(getEncoderPos(rsrx.getTalons().get(ct).getDeviceID())
