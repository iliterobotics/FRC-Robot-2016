...
public class RobotControlWithSRX {
    ...
    public void addDoubleSolenoid(RobotPneumaticType type, int port1, int port2) {
    ...
    public void updateDoubleSolenoid(RobotPneumaticType type, DoubleSolenoid.Value value) {
