...
public class RobotOutputTest 
{
	...
	public RobotOutputTest()
	{
		...
		robotControl.addPneumaticOutput(RobotPneumaticType.GRABBER_PNEUMATIC, 7, 8);
		robotControl.addPneumaticOutput(RobotPneumaticType.LEFT_SHIFTER_PNEUMATIC, 9, 10);
		robotControl.addPneumaticOutput(RobotPneumaticType.RIGHT_SHIFTER_PNEUMATIC, 11,12);
