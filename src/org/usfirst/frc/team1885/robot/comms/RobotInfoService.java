...
public class RobotInfoService {
	...
	private void updateMagnetSensor(){
		firstHookAtBottom = sicInstance.getLimitSwitch(SensorType.MAGNET_SENSOR).get();
	}
...
/*
	...
	- Tote stabilizer solenoid position (DONE)
	- Battery life (DONE)
	- Pressure sensor for pneumatics(Low Pressure/Not Low Pressure) (DONE)
*/