...
public class RobotConfiguration {
    ...
    public static void configureRobot(){
        ...
        SensorInputControl.getInstance().addSensor( SensorType.DRIVE_TRAIN_RIGHT_ENCODER, 0, 1 );
        SensorInputControl.getInstance().addSensor( SensorType.DRIVE_TRAIN_LEFT_ENCODER, 2, 3 );
